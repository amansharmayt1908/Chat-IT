...
const ChatPage = () => {
    ...
    const fetchMessages = async () => {
      try {
        const response = await fetch(`https://app-backend-e41v.onrender.com/getMessages?chatId=${chatId}`);
    ...
    const handleSendMessage = async () => {
      ...
      try {
        const response = await fetch("https://app-backend-e41v.onrender.com/addMessage", {
          method: "POST",
